...
CELERY_RESULT_BACKEND = 'redis://localhost:6379/1'  # Use your own result backend URL
CELERY_ACCEPT_CONTENT = ['json']
CELERY_TASK_SERIALIZER = 'json'
CELERY_RESULT_SERIALIZER = 'json'
CELERY_TIMEZONE = 'UTC'

ESKIZ_EMAIL='komiltuev@icloud.com'
ESKIZ_PASSWORD='BIxAWgiaNUTAlJFq6u6rYgm8rx12fNMt9sLm0huk'